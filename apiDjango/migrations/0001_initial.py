    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('emailCustomer', models.EmailField(max_length=254, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='apiDjango.customer')),
            ],
        ),
        migrations.CreateModel(
            name='Product',
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='apiDjango.category')),
            ],
        ),
        migrations.CreateModel(
            name='OrderDetail',
            fields=[
                ...
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='apiDjango.order')),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='apiDjango.product')),
            ],
        ),
        migrations.CreateModel(
            name='User',
